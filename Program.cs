...
class TicTacToe
{
    ...
    {
        Console.WriteLine($"The player is {currentPlayer}.");
        Console.WriteLine("What number space would you like to use 1-9?");
        string stringChoise = Console.ReadLine();

        int choice = int.Parse(stringChoise);
        return choice;
    }
